...
export function buildWelcomeEmail(data: {
  ...
  const steps = [
    { num: "01", title: "Discovery",  desc: "We go deep into your vision, your users, and your goals. No assumptions — only clarity." },
    { num: "02", title: "Build",      desc: "Our engineers and designers work in tight loops — shipping, refining, and obsessing over every detail." },
    { num: "03", title: "Launch",     desc: "We deliver something that moves — then we stay with you to ensure it keeps performing." },
  ];
  ...
  const body = `
    ...
    <p class="em-p" style="margin:0 0 36px;font-family:${IS};font-size:17px;line-height:1.9;color:#2a2a2a;">
      Your Fox ID above is your permanent member identifier — for every project, every milestone, every conversation we'll ever have together.
    </p>
  ...
  <tr><td class="em-hd" style="background:#0a0a0a;padding:36px 60px 28px;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
      ...
      <td class="em-hd-meta" style="text-align:right;vertical-align:middle;">
        <a href="https://foxmen.studio" style="display:block;font-size:11px;color:${BRAND};text-decoration:none;margin-bottom:5px;">https://foxmen.studio</a>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
      <td style="font-size:11px;color:rgba(255,255,255,.5);line-height:1.6;">Web apps &nbsp;·&nbsp; AI-integrated products &nbsp;·&nbsp; Mobile &amp; software</td>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
        ...
        <td style="text-align:right;vertical-align:middle;padding-left:20px;">
          <table cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin-left:auto;">
            <tr>
              <td style="padding:0 6px 0 0;"><a href="https://www.instagram.com/foxmen_studio/" target="_blank" style="text-decoration:none;" title="Instagram"><table cellpadding="0" cellspacing="0" border="0" role="presentation"><tr><td style="width:32px;height:32px;line-height:32px;font-size:0;padding:0;background:rgba(255,255,255,.15);border-radius:16px;text-align:center;vertical-align:middle;border:1px solid rgba(255,255,255,.3);"><img src="https://cdn.simpleicons.org/instagram/ffffff" width="14" height="14" alt="Instagram" border="0" style="display:inline-block;vertical-align:middle;"/></td></tr></table></a></td>
              <td style="padding:0 6px 0 0;"><a href="https://x.com/FoxmenStudio" target="_blank" style="text-decoration:none;" title="X (Twitter)"><table cellpadding="0" cellspacing="0" border="0" role="presentation"><tr><td style="width:32px;height:32px;line-height:32px;font-size:0;padding:0;background:rgba(255,255,255,.15);border-radius:16px;text-align:center;vertical-align:middle;border:1px solid rgba(255,255,255,.3);"><img src="https://cdn.simpleicons.org/x/ffffff" width="14" height="14" alt="X" border="0" style="display:inline-block;vertical-align:middle;"/></td></tr></table></a></td>
              <td style="padding:0 6px 0 0;"><a href="https://www.linkedin.com/company/foxmen-studio/" target="_blank" style="text-decoration:none;" title="LinkedIn"><table cellpadding="0" cellspacing="0" border="0" role="presentation"><tr><td style="width:32px;height:32px;line-height:32px;font-size:0;padding:0;background:rgba(255,255,255,.15);border-radius:16px;text-align:center;vertical-align:middle;border:1px solid rgba(255,255,255,.3);"><img src="https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/linkedin.svg" width="14" height="14" alt="LinkedIn" border="0" style="display:inline-block;vertical-align:middle;filter:brightness(0) invert(1);"/></td></tr></table></a></td>
              <td><a href="https://www.facebook.com/people/Foxmen-Studio/61579940840061/" target="_blank" style="text-decoration:none;" title="Facebook"><table cellpadding="0" cellspacing="0" border="0" role="presentation"><tr><td style="width:32px;height:32px;line-height:32px;font-size:0;padding:0;background:rgba(255,255,255,.15);border-radius:16px;text-align:center;vertical-align:middle;border:1px solid rgba(255,255,255,.3);"><img src="https://cdn.simpleicons.org/facebook/ffffff" width="14" height="14" alt="Facebook" border="0" style="display:inline-block;vertical-align:middle;"/></td></tr></table></a></td>
            </tr>
          </table>
        </td>
      </tr></table>
