      ...
      <div className="wrap">
        ...
        <div className="foot-mid">
          ...
          <div className="foot-social">
            <a href="https://x.com/FoxmenStudio" target="_blank" rel="noopener noreferrer" aria-label="X / Twitter">
            ...
            <a href="https://www.instagram.com/foxmen_studio/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            <a href="https://www.linkedin.com/company/foxmen-studio/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.facebook.com/people/Foxmen-Studio/61579940840061/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3V2Z" />
              </svg>
            </a>
            <a href="https://dribbble.com/foxmen-studio" target="_blank" rel="noopener noreferrer" aria-label="Dribbble">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
