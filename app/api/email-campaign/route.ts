...
const LOGO = "https://foxmen.studio/assets/logo-mark.svg";
...
<tr><td align="center">
<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="max-width:600px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 8px 48px rgba(0,0,0,.10);">
  ...
  <tr><td style="background:#0a0a0a;padding:36px 48px 28px;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
      <td style="vertical-align:middle;width:48px;padding-right:14px;">
        <img src="${LOGO}" height="44" width="44" alt="Foxmen Studio" style="display:block;"/>
      </td>
      <td style="vertical-align:middle;">
        <div style="font-size:20px;font-weight:400;color:#ffffff;letter-spacing:-.02em;line-height:1;">Foxmen <em style="font-style:italic;color:${BRAND_COLOR};">Studio</em></div>
        <div style="font-size:10px;letter-spacing:.2em;text-transform:uppercase;color:rgba(255,255,255,.35);margin-top:5px;">Code · Craft · Care</div>
      </td>
    </tr></table>
  </td></tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin-top:40px;padding-top:24px;border-top:1px solid #f0ede8;">
      <tr>
        <td style="vertical-align:bottom;">
          <p style="margin:0 0 4px;font-size:14px;color:#9a9a9a;line-height:1.5;">Warm regards,</p>
          <p style="margin:0 0 2px;font-size:16px;font-weight:700;color:#0a0a0a;letter-spacing:-.01em;">The Foxmen Team</p>
          <p style="margin:0;font-size:12px;color:#b0b0b0;">foxmen.studio · contact@foxmenstudio.com</p>
        </td>
        <td style="text-align:right;vertical-align:bottom;width:48px;">
          <img src="${LOGO}" height="32" width="32" alt="" style="display:block;margin-left:auto;opacity:.2;"/>
        </td>
      </tr>
    </table>
  </td></tr>
  ...
  <!-- FOOTER -->
  <tr><td style="background:#0a0a0a;padding:24px 48px;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
      <td>
        <p style="margin:0;font-size:11px;color:rgba(255,255,255,.35);line-height:1.7;">
          <a href="https://foxmen.studio" style="color:rgba(255,255,255,.55);text-decoration:none;">foxmen.studio</a>
          &nbsp;·&nbsp;contact@foxmenstudio.com<br/>
          © ${year} Foxmen Studio. All rights reserved.
        </p>
      </td>
      <td style="text-align:right;">
        <img src="${LOGO}" height="24" width="24" alt="" style="display:block;margin-left:auto;opacity:.2;"/>
      </td>
    </tr></table>
  </td></tr>
