      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
        ...
        <td style="text-align:right;vertical-align:middle;padding-left:20px;">
          <table cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin-left:auto;">
            <tr>
              <td style="padding:0 7px 0 0;"><a href="https://www.instagram.com/foxmen_studio/" target="_blank" style="text-decoration:none;" title="Instagram"><table cellpadding="0" cellspacing="0" border="0" role="presentation"><tr><td style="width:32px;height:32px;background:rgba(255,255,255,.15);border-radius:16px;text-align:center;vertical-align:middle;border:1px solid rgba(255,255,255,.3);"><img src="https://cdn.simpleicons.org/instagram/ffffff" width="14" height="14" alt="Instagram" border="0" style="display:block;margin:9px auto;"/></td></tr></table></a></td>
              <td style="padding:0 7px 0 0;"><a href="https://x.com/FoxmenStudio" target="_blank" style="text-decoration:none;" title="X (Twitter)"><table cellpadding="0" cellspacing="0" border="0" role="presentation"><tr><td style="width:32px;height:32px;background:rgba(255,255,255,.15);border-radius:16px;text-align:center;vertical-align:middle;border:1px solid rgba(255,255,255,.3);"><img src="https://cdn.simpleicons.org/x/ffffff" width="14" height="14" alt="X" border="0" style="display:block;margin:9px auto;"/></td></tr></table></a></td>
